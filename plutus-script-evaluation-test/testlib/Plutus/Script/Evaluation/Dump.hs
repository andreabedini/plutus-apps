...
import Cardano.Streaming (foldLedgerStateEvents, singletonLedgerStateHistory, withChainSyncEventStream)
...
|]
        ...
        let onSocketDoesNotExistException e
            ...
            startStreaming = handle onApplyBlockException
              . handle onSocketDoesNotExistException

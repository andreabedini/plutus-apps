...
emulatorStateInitialDist params mp = do
    ...
    let
        someTxIn = C.TxIn "01f4b788593d4f70de2a45c2e1e87088bfbdfa29577ae1b62aba60e095e3ab53" (C.TxIx 40214)
        txBodyContent = emptyTxBodyContent
           { C.txIns = [ (someTxIn, C.BuildTxWith (C.KeyWitness C.KeyWitnessForSpending)) ]
           , C.txInsCollateral = C.TxInsCollateral C.CollateralInBabbageEra [someTxIn]
